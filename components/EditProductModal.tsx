...
const EditProductModal: React.FC<EditProductModalProps> = ({ product, isOpen, onClose, onSuccess }) => {
    ...
    useEffect(() => {
        if (isOpen && product) {
            ...
            setCostoCompra(product.costoCompra ? product.costoCompra.toString() : '');
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await updateProduct(product.id, {
                ...
                costoCompra: costoCompra && !isNaN(parseFloat(costoCompra)) ? parseFloat(costoCompra) : undefined
            });
                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 max-h-[80vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSave} className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700">Costo (sin receta)</label>
                                    <input
                                        type="number"
                                        step="10"
                                        className="mt-1 block w-full bg-gray-50 border border-gray-300 rounded-md shadow-sm p-2 text-gray-900 focus:ring-coffee-500 focus:border-coffee-500"
