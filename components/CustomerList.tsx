            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Compras</th>
                    ...
                    return (
                      <tr key={customer.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="text-sm font-bold text-gray-900">{customer.totalPurchases || 0}</div>
                          {customer.totalSpent !== undefined && customer.totalSpent > 0 && (
                            <div className="text-[10px] text-gray-500">{new Intl.NumberFormat('es-CL', { style: 'currency', currency: 'CLP' }).format(customer.totalSpent)}</div>
                          )}
                        </td>
