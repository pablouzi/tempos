...
const ProductCard: React.FC<ProductCardProps> = ({ product, onAdd, onEdit, onDelete }) => {
  ...
  return (
    <div 
      ...
      className="bg-[var(--card-bg)] shadow-card hover:shadow-lg transition-all duration-200 cursor-pointer relative group border border-transparent hover:border-brand-orange/10 flex flex-col h-full overflow-hidden"
